                ...
                <View style={style.fondo3}>
                    <View style={{ marginTop: 20, marginLeft: 20 }}>
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={style.sesion}>Chester</Text>
                        ...
                        <Text style={style.estadoMascota}>Adoptado</Text>
                        <Text style={style.descripcionMascota}>Hola me llamo Chester, soy muy juguetón, me gusta salir a jugar. Mi comida favorita es el pollo.</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                        <View style={style.containerCarac}>
                            <Text> Edad</Text>
                            <Text style={{ fontWeight: "bold" }}> 3 años</Text>
                        </View>
                        <View style={style.containerCarac}>
                            <Text> Peso</Text>
                            <Text style={{ fontWeight: "bold" }}> 4 Kg</Text>
                        </View>
                        <View style={style.containerCarac}>
                            <Text> Comida</Text>
                            <Text style={{ fontWeight: "bold" }}> Pollo</Text>
                        </View>
                    </View>
